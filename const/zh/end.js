export const RESULT_CONFIG = {
    excelente: {
        ...
        title: '匿名先知',
        summary: '你是所有人都听到的声音，你的预言总会实现，但没人知道你的身份。你创造了传奇，影响力巨大。'
    },
    bien: {
        ...
        title: '文字点金者',
        summary: '你是写作界的秘密宝藏，把文字变成黄金。未来一片光明。'
    },
    regular: {
        ...
        title: '合格作家',
        summary: '你继续写作，但不是最优秀的。你的作品尚可，但不突出。需要更加努力才能脱颖而出。'
    },
    inaceptable: {
        ...
        title: '叙事失败者',
        summary: '你写作失败了。以下是你可以尝试的其他职业："吸尘器推销员"、"披萨送货员"、"公路酒吧服务员"...'
    }
};
