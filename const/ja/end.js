export const RESULT_CONFIG = {
    excelente: {
        ...
        badge: '最高のスコア',
        title: '匿名の預言者',
        summary: 'あなたは誰もが聞く声であり、予言が実現するが、あなたの正体は誰も知らない。伝説を作り、あなたの影響力は計り知れない。'
    },
    bien: {
        ...
        badge: 'よくできました',
        title: '文字のミダス',
        summary: 'あなたはゴーストライティングにとって非常に価値のある秘密の存在であり、言葉を金に変える。あなたには繁栄する未来が待っている。'
    },
    regular: {
        ...
        badge: '普通',
        title: '十分な作家',
        summary: 'あなたは書き続けているが、最高ではない。あなたの仕事は受け入れられるが、輝いていない。目立つためにはもっと努力する必要がある。'
    },
    inaceptable: {
        ...
        badge: 'あなたには向いていません...',
        title: '物語の失敗者',
        summary: 'あなたは書くことに失敗しました。次に挙げるのは、あなたが従事できる可能性のある職業のリストです：「掃除機の販売員」、「ピザ配達員」、「ロードサイドバーのウェイター」...'
    }
};
