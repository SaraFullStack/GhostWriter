export const COMPARTIR_ARCHIVOS = {
    "Jour 1": [
        ...
        { nombre: "Titulaire", tipo: "texto", contenido: "Une chaîne de supermarchés lance un chariot avec GPS" }
    ],
    "Jour 2": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/lock.mp4" },
        { nombre: "Titulaire", tipo: "texto", contenido: "Une femme enfermée chez elle car la serrure 'intelligente' n'a pas reconnu son visage" }
    ],
    "Jour 3": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/clones.mp4" },
        { nombre: "Titulaire", tipo: "texto", contenido: "La nouvelle obsession VIP : pourquoi les célébrités engagent-elles des clones ?" }
    ],
    "Jour 4": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/house.mp4" },
        { nombre: "Titulaire", tipo: "texto", contenido: "Le marché développe un nouveau type de logement économique avec une hypothèque à partager avec un autre couple" }
    ],
    "Jour 5": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/bet.mp4" },
        { nombre: "Titulaire", tipo: "texto", contenido: "Effondrement dans les maisons de paris : 'Arquímedes FC' marque toujours le prochain décimal de π" }
    ],
    "Jour 6": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/boomers.mp4" },
        { nombre: "Titulaire", tipo: "texto", contenido: "Le nouveau patch du jeu vidéo GhostWriter ajoute un 'mode argot pour boomers' qui essaient de comprendre le jeu" }
    ]
};
export const PRENSA = [
