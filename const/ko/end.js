export const RESULT_CONFIG = {
    excelente: {
        ...
        badge: '素晴らしい仕事',
        title: '言葉の達人',
        summary: 'あなたは卓越した作家です。あなたの言葉は魔法です。未来には多くの機会と認知が待っています。このまま続けてください。世界はあなたのような作家を必要としています！'
    },
    bien: {
        ...
        title: '言葉のミダス王',
        summary: 'あなたはゴーストライティングの秘密兵器です。言葉を金に変えます。繁栄した未来が待っています。'
    },
    regular: {
        ...
        title: '十分な作家',
        summary: 'あなたは書き続けていますが、最高ではありません。あなたの仕事は受け入れられますが、輝いていません。目立つためにはもっと努力が必要です。'
    },
    inaceptable: {
        ...
        title: '物語の否定者',
        summary: '執筆の試みに失敗しました。次に、あなたが取り組むことができる可能性のある職業のリストを示します：「掃除機の販売員」「ピザの配達員」「ロードサイドバーのウェイター」など…'
    }
};
