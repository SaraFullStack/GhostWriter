export const COMPARTIR_ARCHIVOS = {
    "Día 1": [
        ...
        { nombre: "Títular", tipo: "texto", contenido: "슈퍼마켓 체인이 GPS가 장착된 카트를 출시하다" }
    ],
    "Día 2": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/lock.mp4" },
        { nombre: "Títular", tipo: "texto", contenido: "스마트 잠금장치가 얼굴을 인식하지 못해 여성이 자신의 집에 갇히다" }
    ],
    "Día 3": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/clones.mp4" },
        { nombre: "Títular", tipo: "texto", contenido: "새로운 VIP 집착: 왜 유명인들이 클론을 고용하는가?" }
    ],
    "Día 4": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/house.mp4" },
        { nombre: "Títular", tipo: "texto", contenido: "시장, 다른 부부와 함께하는 공동 모기지의 새로운 저가 주택 개발" }
    ],
    "Día 5": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/bet.mp4" },
        { nombre: "Títular", tipo: "texto", contenido: "베팅 하우스 '아르키메데스 FC'가 항상 π의 다음 소수를 기록하며 폭락" }
    ],
    "Día 6": [
        { nombre: "video1.mp4", tipo: "video", url: "../../assets/videos/boomers.mp4" },
        { nombre: "Títular", tipo: "texto", contenido: "비디오 게임 GhostWriter의 새로운 패치, 게임을 이해하려는 베이비붐 세대를 위한 '은어 모드' 추가" }
    ]
};
export const PRENSA = [
